    ...
    handler: (router, context) => {
        ...
        router.get(
            ...
            baseRequestHandler(async (ctx) => {
                ...
                const deployment = await deploymentsService.readOne(
                    req.params.id
                )
                if (!deployment) {
            ...
            baseRequestHandler(async (ctx) => {
                ...
                try {
                    ...
                    for (const pod of pods) {
                        for (const containerStatus of pod.status
                            .containerStatuses) {
            ...
            baseRequestHandler(async (ctx) => {
                ...
                if (deploymentData) {
                    ...
                    try {
                        ...
                        const { body: existing } =
                            await client.listNamespacedStatefulSet(
                                'services',
                                undefined,
                                undefined,
                                undefined,
                    ...
                    for (const payload of servicePayloads) {
                        ...
                        try {
                            ...
                            const { body: existing } =
                                await client.listNamespacedService(
                                    'services',
                                    undefined,
                                    undefined,
                                    undefined,
